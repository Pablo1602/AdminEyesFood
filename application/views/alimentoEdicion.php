  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn-danger" id="modal-btn-no">No</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="dialog" id="myform">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-info" id="modal-btn-2-si">Si</button>
            <button type="button" class="btn-danger" id="modal-btn-2-no">No</button>
          </div>
        </div>
    </div>
  </div>
...
modalConfirm(function(confirm){
  if(confirm){
    ...
    window.location.href = "<?php echo base_url().'Alimentos/aprobarEdicion/'.$ind["idAlimentoDenuncia"]; ?>";
...
modalConfirm(function(confirm){
  if(confirm){
    ...
    if ($("#texto").val().length == 0) {
      ...
      window.location.href = "<?php echo base_url().'Alimentos/rechazarEdicion/'.$ind["idAlimentoDenuncia"].'/'?>"+$("#texto").val().trim();
    }
